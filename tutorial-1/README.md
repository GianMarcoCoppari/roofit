...
* ![formula](https://render.githubusercontent.com/render/math?math=\color{blue}\mu=0),
* ![formula](https://render.githubusercontent.com/render/math?math=\color{blue}\sigma=1),
* ![formula](https://render.githubusercontent.com/render/math?math=\color{blue}\alpha=1.5),
* ![formula](https://render.githubusercontent.com/render/math?math=\color{blue}n=1.5).

Change ![formula](https://render.githubusercontent.com/render/math?math=\color{blue}\sigma) to ![formula](https://render.githubusercontent.com/render/math?math=\color{blue}0.3) and visualize the PDF. Generate an unbinned dataset of ![formula](https://render.githubusercontent.com/render/math?math=\color{blue}10000) events. Make a Fit with Maximum Likelihood and visualize the results.
_Tips_:
...
Edit the macro `roofit_empty.cpp` and, following the comments inside, create an Exponential PDF with rate ![formula](https://render.githubusercontent.com/render/math?math=\color{blue}\lambda=-1/\tau) where ![formula](https://render.githubusercontent.com/render/math?math=\color{blue}\tau=3) is the _mean lifetime_. Visualize the PDF. 
Generate a binned dataset of ![formula](https://render.githubusercontent.com/render/math?math=\color{blue}1000) events (bin width equal to ![formula](https://render.githubusercontent.com/render/math?math=\color{blue}0.5)). Make a Fit with Maximum Likelihood. Visualize the results.
Tips:
...
One of the main objectives of the LHC--b experiment is the study of the CP violation through the decay of different particles, like, for example, the ![formula](https://render.githubusercontent.com/render/math?math=\color{blue}b)--flavored mesons.
...
In `B0sInvariantMass.root` an example of invariant mass spectrum for a ![formula](https://render.githubusercontent.com/render/math?math=\color{blue}B_{s}^{0}) meson is stored.
